    ...
    <nav className="bg-black text-white fixed w-full z-20 shadow-md">
      <div className="container mx-auto flex justify-between items-center py-4 px-4 md:px-8">
        ...
        <ul
          ...
          } md:static md:flex md:flex-row md:items-center md:space-x-8 transition-transform duration-300 ease-in-out z-10`}
        >
          ...
          <li className="my-4 md:my-0">
            <a href="/Register" className="block text-lg hover:text-lime-300">
              Register
            </a>
          </li>
          <li className="my-4 md:my-0">
            <a
              href="/login"
              className=" text-white  py-2 rounded-full  transition duration-300"
            >
              Login
            </a>
          </li>
