...
const AboutXcruiter = () => {
  return (
    ...
    >
      ...
      >
        Xcruiter leverer kvalitetssikrede rekrutteringer av fagpersonell,
        nyutdannede og spesialister
      </motion.h2>
      <motion.button
        className="mt-8 py-4 px-10 bg-[#841F84] text-white font-semibold rounded-xl hover:bg-[#bd99bd] transition"
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
